...
<div id="main">
    ...
    <main class="container">
      <div class="card">
        <div class="card-body">
          <h3 class="card-header text-center font-weight-bold text-uppercase py-4">ADD NEW COMMITTEE MEMBERS</h3><br>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-2">
            ...
            <input id="idnum" class="form-control" placeholder="AUTO GENERATE" readonly>
          </div>
          

          <div class="form-group col-md-2">
            <label for="noPhone">*No Phone</label>
            <input type="text" id="noPhone" name="noPhone" class="form-control" required>
          </div>
    ...
    <?php echo "<a href='../Committee/committee.php'>
        <button type='button' class='btn btn-info'>Cancel</button>
        </a>
        <button  type='submit' id='add' name='add' class='btn btn-info'>Add</button>";?></form>
