...
<!-- Side Navi -->
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <li id="nav-item">
            <a href="../ManageProfile/profile.php"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>
  ...
  <!-- Edit Information-->
                                         ...
                                         <div class="row no-margin">
                                            ...
                                            <input class="form-control" name="charityName" type="text" value="<?php echo $chname;?>" required> 
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Admin Name</label>
                                            <input class="form-control" name="adminName" type="text" value="<?php echo $admin;?>" required> 
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Email</label>
